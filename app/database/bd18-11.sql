...
INSERT INTO `equipo_orden_trabajo` VALUES (1,1,1),(2,3,1),(4,2,5),(5,2,6),(6,2,11),(7,2,12),(8,1,13),(9,1,14),(10,1,15);
/*!40000 ALTER TABLE `equipo_orden_trabajo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `equipos_en_deposito`
--
...
/*!50001 CREATE TABLE `equipos_en_deposito` (
  `equipo` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `movimientos_orden`
--

DROP TABLE IF EXISTS `movimientos_orden`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `movimientos_orden` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_movimientos_orden_orden_trabajo_idx` (`orden_trabajo_id`),
  KEY `fk_movimientos_orden_usuario_idx` (`usuario_id`),
  CONSTRAINT `fk_movimientos_orden_orden_trabajo` FOREIGN KEY (`orden_trabajo_id`) REFERENCES `orden_trabajo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_movimientos_orden_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `movimientos_orden`
--

LOCK TABLES `movimientos_orden` WRITE;
/*!40000 ALTER TABLE `movimientos_orden` DISABLE KEYS */;
INSERT INTO `movimientos_orden` VALUES (1,14,'Ingreso para presupuesto',3,'2014-11-18 14:06:21','2014-11-18 14:06:21'),(2,15,'Ingreso para presupuesto',3,'2014-11-18 14:07:20','2014-11-18 14:07:20'),(3,14,'Presupuestado. Trabajo Sugerido: Reinstalacion Sistema operativo',3,'2014-11-18 14:22:08','2014-11-18 14:22:08'),(4,12,'Trabajo Finalizado: cambio de mother, micro y memorias Costo $1750',3,'2014-11-18 14:26:30','2014-11-18 14:26:30'),(5,12,'Equipo Entregado Remito Nro.: 32 Fecha: 2014-11-18 14:30:11',3,'2014-11-18 14:30:11','2014-11-18 14:30:11'),(6,14,'Presupuesto Aceptado su numero de orden de reparacion es: 16',3,'2014-11-18 15:15:28','2014-11-18 15:15:28'),(7,2,'Presupuesto Aceptado su numero de orden de reparacion es: 17',3,'2014-11-18 15:18:14','2014-11-18 15:18:14'),(8,17,'Ingreso para reparacion',3,'2014-11-18 15:18:14','2014-11-18 15:18:14');
/*!40000 ALTER TABLE `movimientos_orden` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `no_retirados`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `no_retirados` (
  `id` tinyint NOT NULL,
  `nro_orden` tinyint NOT NULL,
  `propietario` tinyint NOT NULL,
  `fecha entrada` tinyint NOT NULL,
  `finalizado` tinyint NOT NULL,
  `falla` tinyint NOT NULL,
...
INSERT INTO `orden_trabajo` VALUES (1,1,1,1,'2014-08-13 17:00:00','no enciende','reinstalacion SO','2014-11-14 01:46:16','2014-11-14 01:51:59',300.00,NULL,'1',1,NULL),(2,1,2,1,'2014-10-29 23:57:49','boton de encendido roto rayas en la pantalla','asadfasfsafdsafsafdsafd','2014-11-14 01:53:46','2014-11-18 15:18:14',NULL,NULL,'',1,NULL),(3,1,1,2,'2014-11-13 01:24:40','fasdfsdfsdfasdfsadf','reinstalacion sistema operativo ','2014-11-14 03:33:26',NULL,350.00,'24','',0,NULL),(4,1,3,1,'2014-11-13 01:21:34','fdfsfasdfasfdasdfasdf','cargar equipos','2014-11-14 02:49:49','2014-11-14 03:00:02',NULL,NULL,'',1,NULL),(5,1,3,1,'2014-11-13 01:24:19','fdfsfasdfasfdasdfasdf','reinstalacion sistema operativo','2014-11-14 01:47:30','2014-11-14 01:47:47',NULL,NULL,'1',1,NULL),(6,1,3,2,'2014-11-13 01:24:40','dafdsafsafasdfsaf',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL),(10,1,3,2,'2014-11-14 03:00:02','fdfsfasdfasfdasdfasdf','Reinstalacion de sistema operativo, cambio de fuente y disco','2014-11-14 03:21:44','2014-11-14 03:30:29',750.00,'0027','34',0,4),(11,1,3,2,'2014-11-18 14:03:46','no enciende la porqueria',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL),(12,1,3,2,'2014-11-18 14:04:15','no enciende la porqueria','cambio de mother, micro y memorias','2014-11-18 14:26:30','2014-11-18 14:30:11',1750.00,'25','32',0,NULL),(13,1,1,1,'2014-11-18 14:04:29','no enciende la porqueria',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL),(14,1,1,1,'2014-11-18 14:06:21','no enciende la porqueria','Reinstalacion Sistema operativo','2014-11-18 14:22:08','2014-11-18 15:15:28',NULL,NULL,'',1,NULL),(15,1,1,1,'2014-11-18 14:07:20','no enciende la porqueria',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL),(16,1,1,2,'2014-11-18 15:15:28','no enciende la porqueria',NULL,NULL,NULL,NULL,NULL,NULL,0,14),(17,1,2,2,'2014-11-18 15:18:14','boton de encendido roto rayas en la pantalla',NULL,NULL,NULL,NULL,NULL,NULL,0,2);
...
--
-- Temporary table structure for view `ordenes_pendientes`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `ordenes_pendientes` (
  `nro orden` tinyint NOT NULL,
...
INSERT INTO `usuario` VALUES (3,'jaime','$2y$10$DwGvRCNru4VSSk0uwMWyLu9QTdbwWGcdkS5D1suVF24uYxxzO0EQm','empleado',NULL,NULL,'zDlYvylpngoWSNVeHomaSxGfiigLEYMIdrEs3eR0bGPmXIqPnMbQoOqCYONQ',1,'Empleado');
...
/*!50001 DROP TABLE IF EXISTS `equipos_en_deposito`*/;
/*!50001 DROP VIEW IF EXISTS `equipos_en_deposito`*/;
...
/*!50001 DROP TABLE IF EXISTS `no_retirados`*/;
/*!50001 DROP VIEW IF EXISTS `no_retirados`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE IF EXISTS `ordenes_pendientes`*/;
/*!50001 DROP VIEW IF EXISTS `ordenes_pendientes`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
-- Dump completed on 2014-11-18 13:57:03
